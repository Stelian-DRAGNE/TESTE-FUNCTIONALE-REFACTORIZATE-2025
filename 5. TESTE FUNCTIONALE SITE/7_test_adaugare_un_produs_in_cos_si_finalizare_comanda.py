...
if __name__ == "__main__":
    ...
    if not all([EMAIL, FIRST_NAME, LAST_NAME, PHONE, ADRESS, PC]):
        raise ValueError("❌ Lipsesc variabile în 7.comanda.env (EMAIL, FIRST_NAME, LAST_NAME, PHONE, ADRESS, P.C.)!")
